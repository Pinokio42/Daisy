...
run: async (bot, message, args) => {
    ...
    let Categories = ["admin",  "info", "mod", "roleplay", "utility", "nsfw", "economy"],
    AllCommands = [];

const Emotes = {
    admin: ":crown: Administration",
    info: ":loudspeaker: Information",
    mod: ":star2: Moderation",
    roleplay: ":white_flower: Roleplay",
    utility: ":gear: Utility",
    nsfw: ":sunglasses: Nsfw",
